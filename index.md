...
- [`vignette("kings-creek", package = "preMetabolizer")`](https://connorb.github.io/preMetabolizer/articles/kings-creek.md)
  ...
  variability.
- [`vignette("chemistry-calculations", package = "preMetabolizer")`](https://connorb.github.io/preMetabolizer/articles/chemistry-calculations.md)
  demonstrates dissolved gas and CO2 helper functions.
- [`vignette("physical-properties", package = "preMetabolizer")`](https://connorb.github.io/preMetabolizer/articles/physical-properties.md)
  demonstrates unit conversions, water height, pressure correction, and
  modeled light.
- [`vignette("time-series-utilities", package = "preMetabolizer")`](https://connorb.github.io/preMetabolizer/articles/time-series-utilities.md)
...
- [`vignette("iem", package = "preMetabolizer")`](https://connorb.github.io/preMetabolizer/articles/iem.md)
  works with Iowa Environmental Mesonet network metadata, current
  observations, observation history, and daily summaries.
- [`vignette("tex-mesonet", package = "preMetabolizer")`](https://connorb.github.io/preMetabolizer/articles/tex-mesonet.md)
  works with TexMesonet station metadata, current observations, and
  recent time series.
