...
#' 1517-1528.
#'
#' @seealso [calc_n2_sat()], [calc_o2_sat()], [calc_co2_sat()],
...
#'
#' This function is deprecated. Please use [calc_ar_sat()] instead.
#'
#' @examples
#' # Old:
...
calc_Arsat <- function(
  ...
  lifecycle::deprecate_soft("0.0.0.9000", "calc_Arsat()", "calc_ar_sat()")
  calc_ar_sat(
