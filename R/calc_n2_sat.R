...
#' 1517-1528.
#'
#' @seealso [calc_ar_sat()], [calc_o2_sat()], [calc_co2_sat()],
#'   [calc_ch4_sat()], [calc_n2o_sat()]
#'
#' @examples
...
#'
#' This function is deprecated. Please use [calc_n2_sat()] instead.
#'
#' @examples
#' # Old:
...
calc_N2sat <- function(
  ...
  lifecycle::deprecate_soft("0.0.0.9000", "calc_N2sat()", "calc_n2_sat()")
  calc_n2_sat(
