...
#'
#' @seealso [calc_o2_sat()], [calc_co2_sat()], [calc_ch4_sat()],
...
#'
#' This function is deprecated. Please use [calc_n2o_sat()] instead.
#'
#' @examples
#' # Old:
...
calc_N2Osat <- function(
  ...
  lifecycle::deprecate_soft("0.0.0.9000", "calc_N2Osat()", "calc_n2o_sat()")
  calc_n2o_sat(
