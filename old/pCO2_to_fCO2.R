...
pCO2_to_fCO2 <- function(
  ...
  B <- -1636.75 +
    12.0408 * abs_temp_water -
    0.0327957 * abs_temp_water^2 +
    0.0000316528 * abs_temp_water^3
  ...
  fugacity_coeff <- exp(
    corr_press * (B + 2 * x2 * dCO2_Air) / (R * abs_temp_water)
  )
