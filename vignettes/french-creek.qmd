...
```{r}
#| label: plot-sm-input
#| fig-alt: "Time series of streamMetabolizer data at French Creek."

sm_input |>
  plot_metab_data()
```

See the [streamMetabolizer documentation](https://github.com/ConnorB/streamMetabolizer) for details on model fitting and interpreting metabolism estimates.
